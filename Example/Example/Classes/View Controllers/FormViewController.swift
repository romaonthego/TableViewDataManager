...
class FormViewController: UITableViewController {
    ...
    lazy var dateTimeItem: TableViewDateTimeItem = {
        let item = TableViewDateTimeItem(text: "Date / Time", placeholder: nil, value: NSDate(timeIntervalSinceNow: -1326400), format: "MM/dd/yyyy hh:mm a", datePickerMode: .DateAndTime)
        return item
    }()
